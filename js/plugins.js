 ...
 */
var Message, Print, Println, blocklyToCommandes, builtinRead, commandesToBlockly, effacerMessage, effacerOutput, getPythonText, modifierCss, outf, ouvrirClick, ouvrirClickEdit, ouvrirFichier, ouvrirFichierEdit, plierDeplier, plierDeplierEditeur, runBlockly, runPython, sauverFichier, sauverFichierEdit, tabuler;
...
plierDeplier = function($obj) {
  $obj.toggle();
  return $(".blocklyToolboxDiv").toggle();
};
...
blocklyToCommandes = function(editor) {
