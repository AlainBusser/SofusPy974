...
$(function() {
  ...
  $("button#d2").on("click", function() { // à factoriser à l'occasion
    workspace.clear();
    return $.ajax({
      type: "GET",
      url: "xml/demo2.xml",
  ...
  $("button#d3").on("click", function() { // à factoriser à l'occasion
    workspace.clear();
    return $.ajax({
      type: "GET",
      url: "xml/demo3.xml",
      dataType: "xml",
      success: function(xml) {
        return Blockly.Xml.domToWorkspace($(xml).find("#demo3")[0], workspace);
      }
    });
  });
