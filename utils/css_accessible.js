...
// menu contextuel
modifierCss('.blocklyWidgetDiv .goog-menuitem-content {', 'font:', 'font: bold 15px Arial, sans-serif;');	// taille de la police : ici 15
modifierCss('.blocklyWidgetDiv .goog-menuitem-content {', 'background:', 'background: #0f0;'); // fond de chaque commande : ici vert
modifierCss('.blocklyWidgetDiv .goog-menuitem {', 'background:', 'background: #ff0;'); // fond du menu : ici jaune
